...
import { BookOpen, Users, BarChart3, Settings, LogOut, Menu, X, FileText, Home, Award, Video, Building2 } from "lucide-react"
...
export function Sidebar({ userRole, userName }: SidebarProps) {
  ...
  const studentLinks = [
    { href: "/dashboard", label: "Dashboard", icon: Home },
    { href: "/dashboard/enrolled-courses", label: "Enrolled Courses", icon: BookOpen },
